...
Copyright 2011 by Jeremy Tompkins
...
2. Add a sidebar to your template where you want the post blocks to be

3. Add the widget to that sidebar in the admin menu
